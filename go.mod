module github.com/timtide/go-titan-client
...
replace github.com/linguohua/titan v0.0.0-20221103041228-34cdc2c2678d => github.com/zscboy/titan-ultra-network v0.0.0-20221130073533-ff69f35b8c97
